...
export default function Sidebar({
    ...
    const comingSoonKeys = ['trusses', 'loose', 'labor', 'takeoff', 'quote', 'export', 'items'];
        ...
        <aside className={`sidebar ${collapsed ? 'open' : ''}`}>
            ...
            >
                {items.map((it, idx) => {
                    ...
                    // 3. This is the new logic you requested
                    let isDisabled = false;
                    let titleText = it.label; // Default title for tooltip
